          ...
          <div class="section-body">
            <div class="row">
              ...
              ?>
                  ...
                  <div class="card-header">
                    <h4><?php echo $fetched_data['otp'];?></h4>
                    <div class="card-header-action">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <div class="dropdown-divider"></div>-->
                          <a href="save.php?act=delete&id=<?php echo $fetched_data['id']?>&table=user_otp" onclick="return navConfirm(this.href);" class="dropdown-item has-icon text-danger"><i class="far fa-trash-alt"></i>
                            Delete</a>
                        </div>
                      </div>
                    </div>
