<?php
	...
	if(isset($_SESSION['admin_name']))
	{
		...
		return false;
        exit();
	}else if (($_SESSION['user_email'] == '') || (!isset($_SESSION['user_email']))) {
...
<body>
  ...
  <div class="col-sm-6 col-md-4 col-md-offset-4 centerit">
    <div class="card" id="sample-login">
      <form action="userlogin.php" method="post" name="userlogin">
        <div class="card-header" style="text-align:center; display:block;font-size: x-large; color: #cc0000;">
          <h3 style="text-align:center;"><?php echo 'Valid for once'?></h3>
        </div>
        <div class="card-body pb-0">
          ...
          <h3 style="text-align:center;">Way to go</h3>

          <div class="form-group">
            <label>Enter provided authorization number</label>
            <div class="input-group">
              ...
              <input type="password" class="form-control" placeholder="Code" name="password" required>
            </div>
          </div>
